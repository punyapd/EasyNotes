      ...
      <div className="col-span-1">
        ...
        <Link href="/Dashboard/Notes">
          <div
            className={`${
              isActive == "notes"
                ? "my-1 w-[172px] h-[40px] rounded-[10px] text-white bg-theme flex items-center  p-2 cursor-pointer space-x-3"
                : "my-1 w-[172px] h-[40px] rounded-[10px] text-black flex items-center  p-2 cursor-pointer space-x-3"
            }`}
        ...
        <Link href="/Dashboard/Transitions">
          <div
            className={`${
            ...
            onClick={() => setIsActive("transitions")}
          >
            <AiFillDollarCircle />
